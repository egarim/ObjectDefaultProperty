...
namespace ObjectDefaultProperty.WebApi {
    public partial class ObjectDefaultPropertyWebApiApplication : BlazorApplication {
        public ObjectDefaultPropertyWebApiApplication() {
            InitializeComponent();
        }
        ...
        private void ObjectDefaultPropertyWebApiApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
