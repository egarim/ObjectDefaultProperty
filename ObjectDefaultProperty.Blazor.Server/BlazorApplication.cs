...
namespace ObjectDefaultProperty.Blazor.Server {
    public partial class ObjectDefaultPropertyBlazorApplication : BlazorApplication {
        public ObjectDefaultPropertyBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void ObjectDefaultPropertyBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
